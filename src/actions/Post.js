...
export const FETCH_SINGLE_POST_SUCCESS='readable/actions.Post/FETCH_SINGLE_POST_SUCCESS'
export const FETCH_SINGLE_POST_ERROR='readable/actions.Post/FETCH_SINGLE_POST_ERROR'
...
dispatch=>{
  ...
  .then (
    ...
    error=>{dispatch(acgetPostDetailByIdError(error))
            throw error
            }
  )
}
...
export const GET_All_POST_SUCCESS='readable/actions.Post/GET_All_POST_SUCCESS'
...
export const getAllPosts = () =>
  dispatch => {
    ...
    .then(
      ...
      error=> {dispatch(acGetPostsError(error))
                throw error
              }
    )
  }
...
export const GET_All_POST_BY_CAT_ID='readable/actions.Post/GET_All_POST_BY_CAT_ID'
export const GET_All_POST_BY_CAT_ID_SUCCESS='readable/actions.Post/GET_All_POST_BY_CAT_ID_SUCCESS'
export const GET_All_POST_BY_CAT_ID_ERROR='readable/actions.Post/GET_All_POST_BY_CAT_ID_ERROR'
...
export const getPostsByCat = (category) =>
  dispatch => {
    ...
    return API.getPostsByCat(category)
    .then(
      data=> dispatch(acGetPostsByCatIDSuccess(data)),
      error=> {dispatch(acGetPostsByCatIDError(error))
                throw error
              }
    )
  }
...
dispatch=>{
  ...
  return API.addPost(post)
    .then(
      ...
      error=>{dispatch(acAddPostError(error))
              throw error
              }
    )
}
...
dispatch=>{
  ...
  return API.deletePost(postId)
    .then(
      ...
      error=>{dispatch(acdeletePostError(error))
                throw error
              }
